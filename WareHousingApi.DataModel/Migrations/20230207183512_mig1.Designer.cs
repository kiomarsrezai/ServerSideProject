...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WareHousingApi.Entities.Country", b =>
                {
            ...
            modelBuilder.Entity("WareHousingApi.Entities.FiscalYear", b =>
                {
            ...
            modelBuilder.Entity("WareHousingApi.Entities.Inventory", b =>
                {
            ...
            modelBuilder.Entity("WareHousingApi.Entities.ProductLocation", b =>
                {
            ...
            modelBuilder.Entity("WareHousingApi.Entities.ProductPrice", b =>
                {
            ...
            modelBuilder.Entity("WareHousingApi.Entities.Products", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHousingApi.Entities.Supplier", b =>
                {
                    b.Property<int>("SupplierID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHousingApi.Entities.WareHouse", b =>
                {
                    b.Property<int>("WareHouseID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHousingApi.Entities.Inventory", b =>
                {
                    b.HasOne("WareHousingApi.Entities.FiscalYear", "FiscalYear")
                        .WithMany()
                        .HasForeignKey("FiscalYearID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WareHousingApi.Entities.Products", "Products")
                        .WithMany()
                    ...
                    b.HasOne("WareHousingApi.Entities.WareHouse", "WareHouse")
                        .WithMany()
            ...
            modelBuilder.Entity("WareHousingApi.Entities.Products", b =>
                {
                    b.HasOne("WareHousingApi.Entities.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WareHousingApi.Entities.Supplier", "Supplier")
                        .WithMany()
